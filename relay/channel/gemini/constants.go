...
var ModelList = []string{
	"gemini-1.5-flash", "gemini-1.5-pro", "gemini-1.5-pro-002", "gemini-1.5-pro-001", "veo-3.0-generate-preview",
	"veo-3.0-fast-generate-preview", "gemini-2.0-flash", "gemini-2.5-flash", "gemini-2.5-flash-lite", "gemini-2.5-pro", "gemini-2.5-flash-image-preview",
}
