...
var ModelList = []string{
	...
	"gemini-2.0-flash-thinking", "gemini-2.5-flash-thinking", "gemini-2.5-pro-thinking", "gemini-2.5-flash-lite",
	"gemini-2.0-flash-nothinking", "gemini-2.5-flash-nothinking", "gemini-2.5-pro-nothinking",
}
