...
var ModelList = []string{
	...
	"gemini-2.0-flash-nothinking", "gemini-2.5-flash-nothinking", "gemini-2.5-flash-lite-thinking", "gemini-2.5-pro-nothinking", "gemini-2.5-flash-image", "gemini-3-pro-preview", "gemini-3-pro-preview-thinking",
}
